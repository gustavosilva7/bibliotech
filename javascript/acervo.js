      ...
      listCont +=
        `<section class="sectionLivro"
            style=" display: flex; flex-direction: row; font-weight: 600; background-color: #fff; width: 100%; height: auto; border-radius: 20px;">
                    ...
                    <div class="d2" style="display: flex; flex-direction: column; width: 95%; height: 100%; padding: 0 2%">    
                    ...
                    <div class="d3" style="width: 5%; height: 100%; background: #05704f; border-radius: 0 20px 20px 0;">
