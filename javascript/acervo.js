      ...
      editBtns.forEach(btnEdit => {
        btnEdit.addEventListener("click", (event) => {
          if (typeof btnEdit.closest === "function") {
            ...
            backAcervoEdit.style.display = "flex"
            backAcervoEdit.style.alignItems = "center"
            backAcervoEdit.style.justifyContent = "center"
            ...
            nameEdit.value = livro.nomeDoLivro
            autorEdit.value = livro.nomeDoAutor
            tomboEdit.value = livro.tomboDoLivro
            chegadaEdit.value = livro.dataChegada
            lancamentoEdit.value = livro.Lancamento
            volumeEdit.value = livro.volume
            editoraEdit.value = livro.editora
